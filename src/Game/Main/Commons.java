...
public interface Commons {
    ...
    public static int PaddleInitialX = 370; /*paddle width 60*/
    public static int PaddleInitialY = 470; /*paddle height 10*/
    public static int BallInitialX = 395;   /*ball radius 10*/
    public static int BallInitialY = 465;   /*ball radius 10 -> stick to paddle*/
